    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/grades/teacher/**").hasRole("TEACHER")
                .requestMatchers("/api/grades/publish/**").hasRole("TEACHER")
                .requestMatchers("/api/grades/withdraw/**").hasRole("TEACHER")
